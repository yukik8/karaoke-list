                ...
                ElevatedButton(
                  ...
                  onPressed: (){
                    try {
                      Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context) => FinalRegisterPage(preUrl: widget.preUrl, name: widget.name, id: widget.id, imgUrl: widget.imgUrl, artistName: widget.artistName)));
                    } catch (e, s) {
                      print(s);
                    }
                }, child: Text("登録に進む",
